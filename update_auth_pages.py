...
base_dir = "c:/Users/Praveen/Documents/KISAN-MITRA-AI/frontend/src/pages"
...
"""
with open(os.path.join(base_dir, "Login.tsx"), "w") as f: f.write(login_tsx)

# Update Register.tsx
register_tsx = """import { useState } from 'react';
import { Link, useNavigate } from 'react-router-dom';
...
"""
with open(os.path.join(base_dir, "Register.tsx"), "w") as f: f.write(register_tsx)

print("Auth pages updated with real API calls.")
